...
/** @type {import('lilconfig').LoadersSync} */
...
/**
 * @param {string} name
 * @param {import('lilconfig').Options | import('lilconfig').OptionsSync} options
 * @param {boolean} sync
 * @returns {Required<import('lilconfig').Options | import('lilconfig').OptionsSync>}
 */
function getOptions(name, options, sync) {
	/** @type {Required<import('lilconfig').Options>} */
	const conf = {
		stopDir: os.homedir(),
...
/** @type {(loader: import('lilconfig').Loader, ext: string) => void} */
...
/** @type {import('lilconfig').lilconfig} */
module.exports.lilconfig = function lilconfig(name, options) {
	...
	return {
		async search(searchFrom = process.cwd()) {
			/** @type {import('lilconfig').LilconfigResult} */
			const result = {
				config: null,
				filepath: '',
			};
...
/** @type {import('lilconfig').lilconfigSync} */
